...
const translations = {
  es: {
    ...
    // Goal Location
    'goal.location.title': 'Selecciona la ubicación del gol',
    'goal.location.subtitle': 'Elige dónde se marcó el gol en la portería',
    'goal.location.top.left': 'Arriba Izq.',
    'goal.location.top.center': 'Arriba Centro',
    'goal.location.top.right': 'Arriba Der.',
    'goal.location.middle.left': 'Medio Izq.',
    'goal.location.middle.center': 'Medio Centro',
    'goal.location.middle.right': 'Medio Der.',
    'goal.location.bottom.left': 'Abajo Izq.',
    'goal.location.bottom.center': 'Abajo Centro',
    'goal.location.bottom.right': 'Abajo Der.',
    'goal.location.goal.target': 'Portería',
    'goal.location.cancel': 'Cancelar',
    
    // Photo Upload
    'photo.upload.title': 'Foto del jugador',
    'photo.upload.select': 'Seleccionar foto',
    'photo.upload.save': 'Guardar foto',
    'photo.upload.cancel': 'Cancelar',
    'photo.upload.uploading': 'Subiendo...',
    'photo.upload.selected': 'Archivo seleccionado',
    'photo.upload.size': 'Tamaño',
    'photo.upload.invalid.type': 'Tipo de archivo no válido. Solo se permiten imágenes.',
    'photo.upload.too.large': 'El archivo es demasiado grande. Máximo 5MB.',
    ...
    'match.notes.title.placeholder': 'Título de la nota',
    'match.notes.content.placeholder': 'Describe lo que observaste...',
    
    // Sport-specific actions
    'action.double_penalty_goal': 'Gol de doble penalti',
  ...
  en: {
    ...
    'goal.location.subtitle': 'Choose where the goal was scored',
    ...
    'goal.location.goal.target': 'Goal Target',
    'goal.location.cancel': 'Cancel',
    
    // Photo Upload
    'photo.upload.title': 'Player photo',
    'photo.upload.select': 'Select photo',
    'photo.upload.save': 'Save photo',
    'photo.upload.cancel': 'Cancel',
    'photo.upload.uploading': 'Uploading...',
    'photo.upload.selected': 'Selected file',
    'photo.upload.size': 'Size',
    'photo.upload.invalid.type': 'Invalid file type. Only images are allowed.',
    'photo.upload.too.large': 'File is too large. Maximum 5MB.',
    'photo.upload.failed': 'Failed to upload photo',
    ...
    'match.notes.general': 'General',
    'match.notes.title.placeholder': 'Note title',
    'match.notes.content.placeholder': 'Describe what you observed...',

...
const Dashboard: React.FC = () => {
  const { user } = useAuth();
  const { currentPlan, subscription, hasFeature, canCreateTeam, getUsageStats } = useSubscription();
  ...
  const loadDashboardData = async () => {
    ...
    try {
      ...
      if (savedTeams) {
        ...
        setTeams(demoTeams);
        localStorage.setItem('statsor_teams', JSON.stringify(demoTeams));
        localStorage.setItem('statsor_team_count', '2');
      }
      ...
      if (savedMatches) {
        ...
        localStorage.setItem('statsor_matches', JSON.stringify(demoMatches));
      }
    } catch (error) {
        ...
        >
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div className="flex items-center gap-4">
              {currentPlan && (
                <Badge className={`${
                  currentPlan.id === 'pro' || currentPlan.id === 'club'

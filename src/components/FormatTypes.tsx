        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          once: true
            ...
            <div className="relative">
              <img alt="Ilustración isométrica 3D de análisis de datos de fútbol con tablet, gráficos y estadísticas" className="w-full max-w-lg h-auto" src="/lovable-uploads/ad01409c-b56f-456f-8574-f9346b3e3d81.jpg" />
            </div>
          </motion.div>
        </div>
      </div>

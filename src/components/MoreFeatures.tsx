      ...
      <div className="container px-4 mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <motion.div 
            ...
            viewport={{ once: true }}
            className="bg-blue-600 text-white p-8 rounded-xl shadow-lg border-2 border-blue-400"
          >
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
            className="bg-green-600 text-white p-8 rounded-xl shadow-lg border-2 border-green-400"
          >
